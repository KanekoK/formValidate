jQuery(function($) {
  var $formRequired = $('.form1 dd.must');
  // 必須のフォームの数
  ...
  var counting = function() {
    return $('.form1 dd.complete').length;
  };
  ...
  var judge = function($this) {
    ...
    var inputJudge = $this.children().val();
    console.log(!errJudge);
    console.log(inputJudge);
    console.log(inputJudge != "");
  ...
  $('.form1 dd.must input').on('mouseup keyup change', function() {
